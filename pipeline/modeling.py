...
def build_regression_models(X_train, y_train, selected_models=None, search_type='Random', n_trials=10):
    ...
    model_classes = {
        'LinearRegression': LinearRegression,
        'RandomForestRegressor': RandomForestRegressor,
        'XGBRegressor': XGBRegressor if XGB_AVAILABLE else None,
        'MLPRegressor': MLPRegressor,
        'KNeighborsRegressor': KNeighborsRegressor,
        'SVR': SVR,
        'DecisionTreeRegressor': DecisionTreeRegressor
    ...
    params = {
        ...
        'MLPRegressor': {'hidden_layer_sizes': [(50,), (100,)], 'alpha': [1e-4, 1e-3]},
...
def build_classification_models(X_train, y_train, selected_models=None, search_type='Random', n_trials=10):
    ...
    model_classes = {
        'LogisticRegression': LogisticRegression,
        'RandomForestClassifier': RandomForestClassifier,
        'XGBClassifier': XGBClassifier if XGB_AVAILABLE else None,
        'MLPClassifier': MLPClassifier,
        'KNeighborsClassifier': KNeighborsClassifier,
        'SVC': SVC,
        'DecisionTreeClassifier': DecisionTreeClassifier
    ...
    params = {
        ...
        'XGBClassifier': {'n_estimators': [100, 200], 'max_depth': [6, 10]} if XGB_AVAILABLE else {},
        'MLPClassifier': {'hidden_layer_sizes': [(50,), (100,)], 'alpha': [1e-4, 1e-3]},
